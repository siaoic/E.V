...
from ev.llm.memory.decay import competitive_decay, should_compete
from ev.llm.memory.namespace import NS_SHARED_PROFILE, sanitize_namespace
...
class LiteMemoryBackend(MemoryBackend):
    ...
    async def decay(self) -> int:
        from ev.llm.memory.decay import decay_stale_memories
