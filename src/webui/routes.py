...
from src.webui.routers.bilibili_live import router as bilibili_live_router
...
from src.webui.routers.worlds import router as worlds_router
...
router.include_router(bilibili_live_router)
