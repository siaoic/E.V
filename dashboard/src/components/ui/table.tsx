...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    data-dashboard-table-header="true"
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    data-dashboard-table-body="true"
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    data-dashboard-table-footer="true"
    className={cn(
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    data-dashboard-table-caption="true"
